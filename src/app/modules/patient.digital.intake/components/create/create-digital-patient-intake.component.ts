  ...
  private createPatientForm() {
    ...
    this.patientForm = new FormGroup({
      ...
      'agreement': new FormGroup({
        ...
        'cancellation-policy': new FormControl(null, [Validators.required]),
        'communication-attestation': new FormControl(null, [Validators.required]),
        'authorization': new FormControl(null, [Validators.required]),
        'consent-treatment': new FormControl(null, [Validators.required]),
        'notice-of-privacy-practices': new FormControl(null, [Validators.required]),
        'insurance-eligibility': new FormControl(null, [Validators.required]),
        'assignment-release-of-benefits': new FormControl(null, [Validators.required]),
